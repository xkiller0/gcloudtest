...
@app.route('/api_jv_3/<path:random_characters>', methods=['GET'])
def show_image_nometadata_jv_3(random_characters):
    try:
        # Path to the image file
        file_path = f'static/jv_3.png'
